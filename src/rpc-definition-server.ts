...
import { Project, Node, StructureKind, ClassDeclaration, ClassDeclarationStructure, FunctionDeclaration, MethodDeclaration, SourceFile, InterfaceDeclaration, TypeAliasDeclaration, SyntaxKind } from 'ts-morph'
...
export function collectMthodTypeDeps (method: MethodDeclaration, sfs: SourceFile[]): Array<InterfaceDeclaration | TypeAliasDeclaration> {
